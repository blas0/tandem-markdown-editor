  ...
  "relative inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-lg border font-medium text-base outline-none transition-shadow before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] pointer-coarse:after:absolute pointer-coarse:after:size-full pointer-coarse:after:min-h-11 pointer-coarse:after:min-w-11 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-64 data-loading:select-none data-loading:text-transparent sm:text-sm [&_svg:not([class*='opacity-'])]:opacity-80 [&_svg:not([class*='size-'])]:size-4.5 sm:[&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:-mx-0.5 [&_svg]:shrink-0",
  {
    ...
    variants: {
      ...
      variant: {
        ...
        info: 'not-disabled:inset-shadow-[0_1px_--theme(--color-white/16%)] border-info-solid bg-info-solid text-info-solid-foreground shadow-info-solid/24 shadow-xs hover:bg-info-solid/90 data-pressed:bg-info-solid/90 *:data-[slot=button-loading-indicator]:text-info-solid-foreground [:active,[data-pressed]]:inset-shadow-[0_1px_--theme(--color-black/8%)] [:disabled,:active,[data-pressed]]:shadow-none',
        'destructive-outline':
        ...
        'info-outline':
          'border-input bg-popover not-dark:bg-clip-padding text-info-foreground shadow-xs/5 not-disabled:not-active:not-data-pressed:before:shadow-[0_1px_--theme(--color-black/4%)] hover:border-info/32 hover:bg-info/4 data-pressed:border-info/32 data-pressed:bg-info/4 *:data-[slot=button-loading-indicator]:text-foreground dark:bg-input/32 dark:not-disabled:before:shadow-[0_-1px_--theme(--color-white/2%)] dark:not-disabled:not-active:not-data-pressed:before:shadow-[0_-1px_--theme(--color-white/6%)] [:disabled,:active,[data-pressed]]:shadow-none',
        ghost:
        ...
        tertiary:
          'border-info-foreground bg-info/10 text-info-foreground hover:bg-info/16 data-pressed:bg-info/16 *:data-[slot=button-loading-indicator]:text-info-foreground [:active,[data-pressed]]:bg-info/20',
        'tertiary-success':
          'border-success-foreground bg-success/10 text-success-foreground hover:bg-success/16 data-pressed:bg-success/16 *:data-[slot=button-loading-indicator]:text-success-foreground [:active,[data-pressed]]:bg-success/20',
        'tertiary-destructive':
          'border-destructive-foreground bg-destructive/10 text-destructive-foreground hover:bg-destructive/16 data-pressed:bg-destructive/16 *:data-[slot=button-loading-indicator]:text-destructive-foreground [:active,[data-pressed]]:bg-destructive/20',
      },
    },
  },
);
